...
if __name__ == '__main__':
    ...
    for task in task_zoo:
        ...
        for tan_flag in tan_flag_zoo:
            ...
            naturalimage_runner(target_category=None, model_flag=model, task=task, dataset_split='val',
                                ...
                                eval_flag='logit', tan_flag=tan_flag, cam_method=cam_method_zoo,
                                cam_save=False)
            # for tc_s in tc:
    ...
    # for task in task_zoo:
    #     for tc in tc_zoo:
    #         medical_runner(target_category=None, task=task, dataset_split='val', cam_save=False, eval_flag='logit')
    ...
    esmira_runner(target_category=None, data_dir='D:\\ESMIRA\\ESMIRA_common',
                  target_catename=['CSA','ATL'], target_site=['Wrist'], target_dirc=['TRA', 'COR'], cam_save=False, eval_flag='logit')
    # tc_zoo = [0, 1]
    # for tc in tc_zoo:
